...
class TimelineRenderer extends AbstractRenderer {
	...
	protected List<Resource> getComponentResources(Map attrs, String resourcePath) throws RenderException {
		...
		// Simile ajax api
		Resource simileAjaxApi = new Resource(name: "${resourcePath}/js/simile/simile-ajax-api.js")
		simileAjaxApi.builder.script(type: "text/javascript", src: "${resourcePath}/js/simile/simile-ajax-api.js", "")
		resources << simileAjaxApi

		// Timeline api
		Resource timelineApi = new Resource(name: "${resourcePath}/js/timeline/timeline-api.js")
		timelineApi.builder.script(type: "text/javascript", src: "${resourcePath}/js/timeline/timeline-api.js", "")
		resources << timelineApi
