...
class CalendarMonthViewRenderer extends AbstractRenderer {
	...
	private boolean ignoreYear(ignoreYear, String className) {
		if (ignoreYear instanceof String) {
			return ignoreYear == "true"
		}

		if (ignoreYear instanceof Map && ignoreYear.containsKey(className)) {
	...
	private getDisplayField(displayField, item) {
	...
	private String getItemUrl(itemUrls, String itemUrl, item) {
		String url = ""
